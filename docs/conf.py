...
#     # an arbitrary url.
#     'navbar_links': [
#         ("ISMIR Paper", "http://ccrma.stanford.edu/~jorgeh/", True),
#     ],
...
#     'bootswatch_theme': "flatly", #"spacelab",
...
# # Hack to allow docstrings of functions decorated with class decorators
# # to properly show the docstrings using automodule

# import pygrfnn.utils as utils
...
# utils.MemoizeMutable = no_op_wraps
