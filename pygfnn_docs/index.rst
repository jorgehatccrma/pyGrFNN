...
The code is loosely based on unpublished Matlab code obtained from Mark Velasco on February 2014. Compare to that code, this code base is incomplete, as I'm primarily interested in rhythm processing. That said, the package has been designed to be easily extended. Usually the code is commented where only rhythmic specific implementations have been coded.
